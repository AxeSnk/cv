...
function Card(properties: $CardProperties): JSX.Element {
  return (
    <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
      ...
      <header className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-sky-200/50 sm:col-span-2">{properties.date}</header>
      <div className="z-10 sm:col-span-6">
        ...
        <p className="mt-2 text-sm leading-normal">{properties.description}</p>
